function [err_count, run_time, mistakes, mistakes_idx, SVs, size_SV, TMs] =perceptron(Y, X, id_list, options)
...
%% classifier
alpha =zeros(n_label,N);   % weight matrix
SV = zeros(n_label,N);     % SV matrix
